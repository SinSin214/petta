  ...
  return (
    <footer className="bg-gray-900 text-white">
        ...
        <div className="grid grid-cols-4 gap-3">
          <div className="col-span-2">
            ...
            <div className="flex space-x-4">
              <Button isIconOnly className="text-gray-400 hover:text-white p-2">
          ...
          <div className="col-span-1 col-end-5">
            ...
            <div className="space-y-3 text-gray-400">
              <div className="flex items-center">
                ...
                <span className="text-sm">50 Nguyen Kim Street<br />District 10, Ho Chi Minh City</span>
              </div>
              <div className="flex items-center">
                <Phone className="h-4 w-4 mr-3 text-orange-500" />
                <span className="text-sm">(+84) 901164996</span>
              </div>
              <div className="flex items-center">
      ...
      <div className="border-t border-gray-800 py-4 text-center text-gray-400">
          <p>&copy; 2025 Petta. All rights reserved. Made with ❤️ for animals in need.</p>
        </div>
    </footer>
  );
}